...
<body>
    ...
    <header id="navbar" class="header">
        <div class="nav-container">
            <div class="nav-logo">
            <a href="index.php" ><img src="./images/site-images/logo png.png"  alt="image"></a>
            </div>
    ...
    <div class="post-joke">
      ...
      <div class="btn">
        <a href="login_and_signup.php"><button id="btn-post">Post Your Own Jokes </button></a>
      </div>
      <div class="img">
...
<section id="joke-section">
    ...
    $sql="SELECT username, jokes FROM user_jokes;";
    ...
    ?>
        ...
        <div class="joke-section">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>Why are oranges the smartest fruit? Because they are made to concentrate. </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>I asked a frenchman if he played video games. He said "Wii" </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>Why don't skeletons ride roller coasters? They don't have the stomach for it. </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>Why was ten scared of seven? Because seven ate nine.</p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>What do you do when you see a space man? Park your car, man. </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>Why was Santa's little helper feeling depressed? Because he has low elf esteem. </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>What happens when you anger a brain surgeon? They will give you a piece of your mind. </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>What do you call a beehive without the b's? An eehive. </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
        ...
        <div class="joke-section">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>What do you call a troublesome Canadian high schooler? A poutine. </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>What did one snowman say to the other snow man? Do you smell carrot? </p>
          </div>
        </div>
        <div class="joke-section">
          <div class="imgbox">
          ...
          <div class="content">
            <h2>Keep Smiling</h2>
            <p>Today a girl said she recognized me from vegetarian club, but I’m sure I’ve never met herbivore. </p>
          </div>
        </div>
      </div>
  </section>
      ...
      <ul class="row">
        <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 349px;">
            <figure><img src="./images/site-images/teams/azharuddin.jpg" class="img-responsive" alt=""></figure>
            <h3>Md.Azharuddin</h3>
            <h4>Roll:- Team leader and Database developer !</h4>
            ...
            <ul class="follow-us clearfix">
              ...
              <li><a href="https://www.linkedin.com/in/mdazharuddin02/" target="blank"><i class='bx bxl-linkedin'></i></a></li>
            </ul>
          </div>
       </li>
        ...
        <li class="col-12 col-md-6 col-lg-3">
         ...
         <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 349px;">
            ...
            <h4>Roll:- Front end developer !</h4>
            <p>Maharishi Markandeshwar Deemed to be University, Mullana, Ambala</p>
            <ul class="follow-us clearfix">
              <li><a href="#" target="blank"><i class='bx bxl-facebook-circle' ></i></i></a></li>
